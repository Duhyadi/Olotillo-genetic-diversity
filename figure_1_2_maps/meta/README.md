...
Below is the complete description of all variables included in the file olotillo_PGMN_siagro.csv.
Variable names are shown in Spanish (original), with English definitions.
