...
library(sf)
```
Note: Ya no se usa gpclib y maptools,la mayoría de sus funciones se han migrado a otros paquetes más modernos — principalmente sf, sp, y rgeos (aunque rgeos también está en proceso de retiro).
